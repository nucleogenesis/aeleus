...
OptionParser.parse! do |parser|
  ...
  parser.on("-c COMMAND", "--command=COMMAND", "The command that you want to alias. If your command has spaces, put it between double-quotes. (eg, aelius -a sshproduction -x \"ssh -i ~/.ssh/key user@domain\")") { |c| command = c}
